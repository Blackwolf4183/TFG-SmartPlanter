...
String serverPath = "https://tfg-smartplanter.onrender.com/esp/irrigate?client_id=SmartPlanter1&soil_moisture=30";
...
#pragma endregion Azure methods
...
void setup() {
  ...
  if(WiFi.status()== WL_CONNECTED){
      ...
      // Your Domain name with URL path or IP address with path
      //http.begin(client, "https://tfg-smartplanter.onrender.com", 0, "/esp/irrigate?client_id=SmartPlanter1&soil_moisture=30", true);
      ...
      if (httpResponseCode>0) {
        ...
        if (shouldIrrigate) {
          ...
          Serial.print("Irrigation amount: "); Serial.println(irrigationAmountInt);
        } else {
          Serial.println("Should Irrigate is false");
        }
    ...
    // Clearing cert2 by swapping with a temporary empty X509List object
